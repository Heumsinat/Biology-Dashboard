                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Question Number</th><th>Question Topic</th><th>Question Difficulty</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($question as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->question_number }}</td><td>{{ $item->question_topic }}</td><td>{{ $item->question_difficulty }}</td>
                                        <td>
